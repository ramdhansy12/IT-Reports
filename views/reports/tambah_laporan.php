                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="datetime-local" name="tanggal_kustom" class="form-control"
                                value="<?php echo date('Y-m-d\TH:i'); ?>" required>
                            <small class="text-muted">Klik ikon kalender untuk mengubah jam.</small>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="unit_kerja" class="form-control"
                                placeholder="Contoh: Radiologi, IGD" required>
                        </div>
                    </div>
                    <div class="mb-3">
